...
<div class="layui-container" id="head" style="width: 100%">
    ...
    <div class="layui-container" >
        <form class="layui-form" id="form"  method="post">
            ...
            <label class="layui-form-label">消费ID</label>
            <div class="layui-input-block">
                <input type="text" name="consumeId"  readonly autocomplete="off" placeholder="请输入用户名" class="layui-input"
                       value="${consume.consumeId}">

            </div>
            <br>
            <label class="layui-form-label">消费食物</label>
            <div class="layui-input-block">
                <input type="text" name="consumeFood"  readonly autocomplete="off" placeholder="请输入用户名" class="layui-input"
                value="${consume.consumeFood}">
            ...
            <div class="layui-input-block">
                <input type="text" name="consumeMoney" readonly autocomplete="off" value="${consume.consumeMoney}" class="layui-input">
            </div>
            <br>
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">评论内容</label>
                <div class="layui-input-block">
                    <textarea name="discussMessage" placeholder="请输入内容" class="layui-textarea"></textarea>
                </div>
            </div>
            <br>
...
<script type="text/javascript">
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element','form'], function(){
        ...
        form.on('submit(formDemo)', function(data){
            $.ajax({
                url:"/waimai/qiantaiDiscuss/add.action",
