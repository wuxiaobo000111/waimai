...
<div class="layui-container" id="head" style="width: 100%">
    ...
    <div class="layui-container" >
        <form class="layui-form" id="form" method="post">
            <label class="layui-form-label">送餐联系人</label>
            <div class="layui-input-block">
                <input type="text" name="addressLianxi"  autocomplete="off" placeholder="请输入送餐联系人" class="layui-input"
                      >
                <p id="message"></p>
            </div>

            <br>
            <label class="layui-form-label">送餐电话</label>
            <div class="layui-input-block">
                <input type="text" name="addressPhone" autocomplete="off" placeholder="请输入11位手机号码" class="layui-input">
            </div>
            <br>
            <label class="layui-form-label">送餐地址</label>
            <div class="layui-input-block">
                <input type="text" name="addressName"  autocomplete="off" placeholder="请输入送餐地址" class="layui-input">
            </div>
            <br>
            <br>
...
<script type="text/javascript">
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element','form'], function(){
        ...
        form.on('submit(formDemo)', function(data){
            ...
            $.ajax({
                url:"/waimai/qiantaiAddress/add.action",
