    ...
    <div class="col-md-12">
        <form class="form-horizontal" id="form" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" id="flag" value="${newsType.newsTypeName}" name="newsTypeName"  class="form-control">
                </div>
            </div>
            <div class="form-group" hidden>
                <div class="col-sm-8">
                    <input type="text" name="foodTypeId" value="${newsType.newsTypeId}" id="newsTypeId" class="form-control" hidden>
                </div>
            </div>
