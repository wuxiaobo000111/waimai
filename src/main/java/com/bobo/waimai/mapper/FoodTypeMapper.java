...
/**
 * Created by bobo on 2018/2/1/17:42.
 */
public interface FoodTypeMapper {
    public List<FoodType> getPageFoodType(@Param(value = "limit") Integer limit,
    ...
    public List<FoodType> getPageFoodTypeSearch(@Param(value = "searchName") String searchName,
