...
<div class="layui-container" id="head" style="width: 100%">
    ...
    <div class="layui-container" >
        ...
        <form class="layui-form" id="form" method="post">
            <div hidden="hidden">
                <input type="text" name="userId" value="${user.userId}" hidden="hidden" autocomplete="off" class="layui-input">
            </div>
            <label class="layui-form-label">用户名</label>
            <div class="layui-input-block">
                <input type="text" name="userName" id="userName" value="${user.userName}" autocomplete="off" placeholder="请输入用户名" class="layui-input"
            ...
            <div class="layui-input-block">
                <input type="text" name="userPhone" value="${user.userPhone}" autocomplete="off" placeholder="请输入用户11位手机号码" class="layui-input">
            </div>
            <br>
            <label class="layui-form-label">用户邮箱</label>
            <div class="layui-input-block">
                <input type="text" name="userEmail" value="${user.userEmail}"  autocomplete="off" placeholder="请输入用户邮箱" class="layui-input">
            </div>
            <br>
            <br>
            <label class="layui-form-label">用户密码</label>
            <div class="layui-input-block">
                <input type="password" name="userPassword" value="${user.userPassword}" autocomplete="off" placeholder="请输入用户名密码" class="layui-input">
            </div>
            <br>
...
<script type="text/javascript">
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element','form'], function(){
        ...
        form.on('submit(formDemo)', function(data){
            $.ajax({
                url:"/waimai/qiantaiuser/update.action",
